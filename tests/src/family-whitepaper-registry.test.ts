...
test('family whitepaper registry exposes separate family and Framework documents', () => {
  ...
  assert.deepEqual(output.whitepapers.map(({ id }) => id), ['opl-family', 'opl-framework', 'opl-app', 'opl-cloud', 'mas']);
