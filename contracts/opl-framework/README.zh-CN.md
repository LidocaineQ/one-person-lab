...
- brand-module governance 通过 registry、模块自有品牌 CLI command surface、read-model projection、validation gate 和 false-authority boundary，让 Charter、Atlas、Workspace、Pack、Stagecraft、Runway、Ledger、Console、Foundry Kernel 与 Connect 保持 Workspace-level structural baseline
