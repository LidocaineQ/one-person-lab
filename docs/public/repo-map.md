...
| [`opl-studio`](https://github.com/gaofeng21cn/opl-studio) | DSH-derived 开发备选 Shell | Chat-first renderer、Client Cordis、candidate bridge/readback 实验 | active shell adoption、release readiness、runtime/package truth |
...
3. 想开发 GUI shell：主线看 [`opl-aion-shell`](https://github.com/gaofeng21cn/opl-aion-shell)，备选实验看 [`opl-studio`](https://github.com/gaofeng21cn/opl-studio)。
