...
const MODULE_SURFACE_READBACK_REFS = [
  {
    ...
    source_module_ref: 'src/authority/packages/evidence-grounded-decision-agent-profile.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/authority/stages/evidence-grounded-decision-agent-profile.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/adapters/execution/evidence-grounded-decision-agent-profile.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/authority/evidence/evidence-grounded-substrate.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/adapters/integration/evidence-grounded-substrate.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/authority/workspace/evidence-grounded-substrate.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/read-models/catalog/evidence-grounded-profile-catalog.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/read-models/operator/evidence-grounded-profile-drilldown.ts',
  ...
  },
  {
    ...
    source_module_ref: 'src/authority/contracts/evidence-grounded-decision-agent-profile.ts',
