...
import { resolveStandardAgentImplementationProfile } from './public/standard-agent-implementation-profile.ts';
...
export function buildStandardDomainAgentScaffoldValidation(input: ScaffoldValidateInput) {
  ...
  return {
    ...
    standard_domain_agent_scaffold: {
      ...
      api_ref: 'opl.pack.validateStandardDomainAgentScaffold',
