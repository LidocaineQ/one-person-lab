import { buildAppStageRunCockpit } from '../stages/index.ts';
import {
  record,
...
export type OwnerDeltaObservationInput = {
  currentOwnerDeltaReadModel: unknown;
};

export type OwnerDeltaTopline = ReturnType<typeof buildCurrentOwnerDeltaTopline>;

export type OwnerDeltaObserverService = {
  observe(input: OwnerDeltaObservationInput): OwnerDeltaTopline;
};

export function buildCurrentOwnerDeltaTopline(input: OwnerDeltaObservationInput) {
