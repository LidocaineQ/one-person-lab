...
import { validateBrandModuleSurfaces } from './brand-module-surfaces-contract.ts';
...
import { validatePublicSurfaceIndex } from './contract-validators/public-surface-index-contract.ts';
