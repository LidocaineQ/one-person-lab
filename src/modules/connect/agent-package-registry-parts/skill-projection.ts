...
import type { AgentPackageSkillProjection } from './types.ts';
...
function assertProjectionBytes(projection: AgentPackageSkillProjection) {
  ...
  if (!path.isAbsolute(projection.projection_root)
    ...
    || projection.projection_root !== expectedProjectionRoot
