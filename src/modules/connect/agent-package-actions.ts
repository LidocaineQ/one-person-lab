...
const AGENT_PACKAGE_ACTION_CATALOG = [
  {
    ...
    mutates: 'opl_agent_package_lock_and_physical_carrier',
    dry_run_supported: true,
    confirmation_required: true,
    danger_level: 'medium',
    impact: 'Validates one manifest and records the package lock and carrier refs without owning agent domain semantics.',
  ...
  },
  {
    ...
    confirmation_required: true,
    danger_level: 'medium',
    impact: 'Re-materializes the package carrier surface from the existing lock and returns fresh physical readback.',
    follow_up_action_ids: [],
  },
  {
