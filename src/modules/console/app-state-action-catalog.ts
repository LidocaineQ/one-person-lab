...
export function buildActionCatalog(
  ...
  const actions: AppActionCatalogEntry[] = [
    ...
    },
    {
      ...
      label: 'Provision submission resource',
      surface: 'opl app action execute',
      delegated_surface: 'opl pack provision-submission-resource',
      payload_fields: [
        'requirements_path',
      ...
      mutates: 'opl_pack_content_addressed_submission_resource_cache',
      dry_run_supported: true,
      confirmation_required: false,
      danger_level: 'low',
      impact: 'caches_existing_exact_local_resource_bytes_and_writes_false_authority_receipt',
    },
    {
      action_id: 'work_item_execution_session_observe',
      label: 'Observe work item coordination session activity',
      surface: 'opl app action execute',
      delegated_surface: 'OPL work-item coordination-session binding ledger',
      payload_fields: [
        'agent_id',
        'project_id',
        'project_scope_id',
      ...
      mutates: 'opl_work_item_execution_session_binding_ledger',
      dry_run_supported: true,
      confirmation_required: false,
      danger_level: 'low',
      impact: 'records_refs_only_coordination_activity_without_transcript_stage_attempt_or_domain_truth_mutation',
    },
    {
      action_id: 'work_item_lifecycle_set',
      label: 'Change work item lifecycle',
      surface: 'opl app action execute',
      delegated_surface: 'OPL Ledger work-item control transition',
      payload_fields: [
        'agent_id',
        'project_id',
        'work_item_id',
      ...
      mutates: 'opl_work_item_control_ledger',
      dry_run_supported: true,
      confirmation_required: true,
      danger_level: 'medium',
      impact: 'changes_user_collaboration_lifecycle_only_without_writing_domain_truth',
    },
    {
      action_id: 'work_item_visibility_set',
      label: 'Change work item visibility',
      surface: 'opl app action execute',
      delegated_surface: 'OPL Ledger work-item visibility transition',
      payload_fields: [
        'agent_id',
        'project_id',
        'work_item_id',
      ...
      confirmation_required: true,
      danger_level: 'medium',
      impact: 'changes_work_item_visibility_only_without_stopping_runtime_or_writing_domain_truth',
    },
    {
    ...
    },
    {
      ...
      label: 'Restart managed Temporal service',
      surface: 'opl app action execute',
      delegated_surface: 'opl family-runtime service restart --provider temporal',
      payload_fields: [],
      mutates: 'opl_temporal_service',
      impact: 'restart_only_the_opl_managed_temporal_server_and_verify_fresh_readiness',
    },
    {
      action_id: 'provider_service_stop',
      label: 'Stop managed Temporal service',
      surface: 'opl app action execute',
      delegated_surface: 'opl family-runtime service stop --provider temporal',
      payload_fields: [],
      mutates: 'opl_temporal_service',
      impact: 'stop_only_the_opl_managed_temporal_server_or_supervisor',
    },
    {
    ...
    {
      action_id: 'provider_worker_stop',
      label: 'Stop managed Temporal worker',
      surface: 'opl app action execute',
      delegated_surface: 'opl family-runtime worker stop --provider temporal',
      payload_fields: [],
      mutates: 'opl_temporal_worker',
    },
  ];
