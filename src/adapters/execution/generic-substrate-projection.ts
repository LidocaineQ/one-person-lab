...
function sourceRefEntries(manifest: DomainManifestRecord | null) {
...
function artifactRefEntries(manifest: DomainManifestRecord | null) {
...
function memoryRefEntries(manifest: DomainManifestRecord | null) {
...
function manifestCatalog(_contracts: FrameworkContracts, options: GenericSubstrateOptions) {
  return options.domainManifests
    ?? emptyDomainManifestCatalog();
}
