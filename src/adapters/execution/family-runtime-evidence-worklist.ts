...
import { buildProductionTailNextActionLedger } from '../../authority/evidence/index.ts';
import { compactEvidenceEnvelopeProjection } from '../../authority/evidence/index.ts';
import {
...
import type { StageReplayMissingReceiptReceipt } from '../../authority/stages/index.ts';
...
import { writeCurrentOwnerDeltaReadModelProjectionCache } from '../../authority/evidence/index.ts';
import {
...
export async function runFamilyRuntimeEvidenceWorklist(
  ...
  return runFamilyRuntimeEvidenceWorklistWithObserver(contracts, {
    ...input,
    ownerDeltaObserver: input.ownerDeltaObserver ?? {
      observe: buildCurrentOwnerDeltaTopline,
    },
  });
}
