...
type CapabilityHardBoundary = import('../integration/index.ts').CapabilityHardBoundary;
type CapabilityRegistryReadout = import('../integration/index.ts').CapabilityRegistryReadout;
type CapabilityRegistryResolution = import('../integration/index.ts').CapabilityRegistryResolution;
type CurrentOwnerDeltaCapabilityBinding = import('../integration/index.ts').CurrentOwnerDeltaCapabilityBinding;
type CurrentOwnerDeltaCapabilityRequirement = import('../integration/index.ts').CurrentOwnerDeltaCapabilityRequirement;
