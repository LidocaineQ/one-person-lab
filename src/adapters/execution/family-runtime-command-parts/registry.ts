...
import { parseReviewTransportArgs } from './review-transport.ts';
...
const FAMILY_RUNTIME_COMMAND_REGISTRY: FamilyRuntimeCommandParser[] = [
  ...
  {
    command_path: 'review',
    parse: (mode, rest) => mode === 'review' ? parseReviewTransportArgs(rest) : null,
  },
  {
