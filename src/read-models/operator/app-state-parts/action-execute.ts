...
import { writeOplWorkspaceRootSurface } from '../../../adapters/integration/index.ts';
...
import { MANAGED_UPDATE_OWNER_ACTIONS, managedUpdateCommand } from '../../../adapters/integration/index.ts';
...
import { buildOplDockerWebuiDoctor } from '../../../adapters/integration/index.ts';
import { runOplTurnkeyInstall } from '../../../adapters/integration/index.ts';
