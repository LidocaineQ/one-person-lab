...
import type { DomainManifestCatalogEntry, NormalizedDomainManifest } from '../../catalog/index.ts';
...
import { defaultCallerSurfaceGates } from '../../../authority/workspace/index.ts';
import {
  ...
  return {
    ...
    missing_gate_groups: {
      ...
      domain_owner_decision: {
        status: ownerDecisionReadModel.owner_decision_status,
