...
import { FUNCTIONAL_PRIVATIZATION_AUDIT_ENVELOPE_CONTRACT } from '../../authority/packages/index.ts';
...
const DOMAIN_SPECIFIC_CARRIER_BOUNDARIES = [
  {
    ...
    source_evidence_refs: [
      'src/adapters/execution/family-runtime-domain-route.ts',
      'src/adapters/execution/family-runtime-domain-route-terminal-sync.ts',
    ],
  },
  {
    ...
    source_evidence_refs: [
      'src/authority/stages/family-transition-visual-ingestion.ts',
    ],
  },
  {
    ...
    source_evidence_refs: [
      'src/authority/stages/quality-gate-runtime.ts',
      'src/authority/evidence/current-owner-delta-parts/projection.ts',
    ],
  },
  {
    ...
    source_evidence_refs: [
      'src/adapters/execution/generic-substrate-projection.ts',
      'src/kernel/standard-agent-registry.ts',
      'src/authority/evolution/risk-policy.ts',
    ],
  },
] as const;
...
export function buildOplFrameworkSemanticHygieneAudit(contracts: FrameworkContracts) {
  ...
  const gates: SemanticHygieneGate[] = [
    ...
    },
    {
      ...
      owner: 'one-person-lab',
      source_evidence: [
        'src/adapters/execution/family-runtime-command.ts',
        'src/adapters/execution/family-runtime-command-parts/registry.ts',
        'src/adapters/execution/family-runtime-command-parts/shared.ts',
        'src/adapters/execution/family-runtime-command-parts/provider.ts',
