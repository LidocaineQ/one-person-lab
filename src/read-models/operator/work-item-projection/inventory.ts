...
import { readStandardAgentDescriptorForDomain } from '../../../adapters/integration/index.ts';
import { deriveWorkItemScopeId } from '../../../authority/workspace/public/app-state.ts';
