...
export const SETTINGS_CONTROL_CENTER_GROUPS: SettingsControlCenterGroup[] = [
  ...
  },
  {
    ...
    route_id: 'storage',
    action_section_ids: ['runtime_roots', 'storage_lifecycle'],
    ordinary_entry_policy: 'top_level_control_center_route',
  },
  {
...
export const SETTINGS_CONTROL_CENTER_ACTION_SECTIONS: SettingsSection[] = [
  ...
  },
  {
    ...
    description: 'Managed OPL Packages, generated assistants, and capability sync actions.',
    state: 'available',
    source_ref: 'app_state.agent_packages + app_state.assistants',
  },
  {
    section_id: 'packages',
    label: 'OPL packages',
    description: 'OPL Packages channel, release channel, and install/update actions.',
    state: 'available',
    source_ref: 'app_state.agent_packages + app_state.release',
  },
  {
  ...
  {
    section_id: 'storage_lifecycle',
    label: 'Owner-managed storage inventory',
    description: 'Lazy Agent Package and WebUI usage inventories plus canonical owner routes.',
    state: 'available',
    source_ref: 'app_state.settings_control_center.app_settings_read_model.storage_lifecycle',
  },
];
...
export const SETTINGS_CONTROL_CENTER_ACTIONS: SettingsAction[] = [
  {
    ...
    payload_fields: ['group_id'],
    mutates: 'opl_gateway_account_and_managed_key',
    dry_run_supported: false,
    confirmation_required: false,
    danger_level: 'low',
    impact: 'Creates or reuses only the installation-bound OPL App managed key.',
    follow_up_action_ids: ['gateway_account_refresh'],
  },
  {
    ...
    payload_fields: [],
    mutates: 'opl_gateway_rotating_session_and_cache',
    dry_run_supported: false,
    confirmation_required: false,
    danger_level: 'low',
    impact: 'Rotates the private refresh token and updates the cached account projection.',
  ...
  },
  {
    ...
    confirmation_required: false,
    danger_level: 'low',
    impact: 'Reconciles only the installation-bound OPL App managed key.',
    follow_up_action_ids: ['gateway_account_refresh'],
  },
  {
    ...
    danger_level: 'medium',
    impact: 'Selects the managed key as the local Codex provider using CAS-protected restoration.',
    follow_up_action_ids: ['gateway_account_refresh'],
  },
  {
    ...
    payload_fields: [],
    mutates: 'opl_gateway_managed_key_and_private_session',
    dry_run_supported: false,
    confirmation_required: true,
    danger_level: 'medium',
    impact: 'Disables rather than deletes the installation-bound managed key and restores owned Codex fields.',
    follow_up_action_ids: [],
  },
  {
  ...
  },
  {
    ...
    delegated_surface: managedUpdateCommand('apply', 'opl_packages', { json: false }),
    payload_fields: [],
  ...
  ...listAgentPackageSettingsActions(),
  {
    ...
    stable_id: 'check_opl_base_update',
    label: 'Check OPL Base update',
    section_id: 'updates',
    task_kind: 'check',
    taxonomy: 'settings.updates.check_opl_base_update',
    delegated_surface: managedUpdateCommand('check', 'opl_base', { json: false }),
    payload_fields: [],
    mutates: 'none_read_only',
    dry_run_supported: true,
    confirmation_required: false,
    danger_level: 'none',
    impact: 'Checks only the OPL Base component through the managed update coordinator without mutating runtime state.',
    follow_up_action_ids: [],
    verify_action_id: 'settings_check_opl_base_update',
  },
  {
    action_id: 'settings_apply_opl_base_update',
    stable_id: 'apply_opl_base_update',
    label: 'Apply OPL Base update',
    section_id: 'updates',
    task_kind: 'apply',
    taxonomy: 'settings.updates.apply_opl_base_update',
    delegated_surface: managedUpdateCommand('apply', 'opl_base', { json: false }),
    payload_fields: [],
    mutates: 'opl_base_runtime_substrate',
    dry_run_supported: true,
    confirmation_required: true,
    danger_level: 'medium',
    impact: 'Applies only the OPL Base component through its managed update owner and records the resulting component receipt.',
    follow_up_action_ids: ['settings_check_opl_base_update'],
    rollback_action_id: 'settings_rollback_runtime_substrate',
    verify_action_id: 'settings_check_opl_base_update',
  },
  {
    ...
    delegated_surface: managedUpdateCommand('status', 'opl_app', { json: false }),
    payload_fields: [],
    mutates: 'none_read_only',
    dry_run_supported: true,
    confirmation_required: false,
  ...
  },
  {
    ...
    stable_id: 'inventory_agent_package_store',
    label: 'Refresh Agent Package storage inventory',
    section_id: 'storage_lifecycle',
    task_kind: 'read',
    taxonomy: 'settings.storage.agent_package_store.inventory',
    delegated_surface: 'opl app action execute --action settings_inventory_agent_package_store',
    payload_fields: [],
    mutates: 'opl_storage_owner_inventory_snapshot_cache',
    dry_run_supported: true,
    confirmation_required: false,
    danger_level: 'none',
    impact: 'Measures only safe package-owned current and last-known-good roots; cleanup stays with agent_package_uninstall.',
    follow_up_action_ids: [],
    verify_action_id: 'settings_inventory_agent_package_store',
  },
  {
    action_id: 'settings_inventory_webui_data_volume',
    stable_id: 'inventory_webui_data_volume',
    label: 'Refresh WebUI data storage inventory',
    section_id: 'storage_lifecycle',
    task_kind: 'read',
    taxonomy: 'settings.storage.webui_data_volume.inventory',
    delegated_surface: 'opl app action execute --action settings_inventory_webui_data_volume',
    payload_fields: [],
    mutates: 'opl_storage_owner_inventory_snapshot_cache',
    dry_run_supported: true,
    confirmation_required: false,
    danger_level: 'none',
    impact: 'Runs a bounded no-follow inventory that excludes Projects; destructive actions remain carrier-host owned.',
    follow_up_action_ids: [],
    verify_action_id: 'settings_inventory_webui_data_volume',
  },
  {
    ...
    delegated_surface: managedUpdateCommand(MANAGED_UPDATE_OWNER_ACTIONS.revert, 'opl_base', { json: false }),
