...
type DomainManifestCatalogService = (
  contracts: FrameworkContracts,
  options?: DomainManifestCatalogOptions,
...
export type LaunchDomainEntryOptions = {
  ...
  atlas?: DomainManifestCatalogService;
      ...
      domain_entry_launch: {
        ...
        domain_manifest_recommendation: manifestEntry
          ? {
              ...
              domain_agent_entry_spec:
                manifestEntry.manifest?.domain_entry_contract?.domain_agent_entry_spec ?? null,
              product_entry_surface: manifestEntry.manifest?.product_entry_surface ?? null,
