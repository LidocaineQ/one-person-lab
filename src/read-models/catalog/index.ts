...
export type CordisDomainManifestCatalogOptions = Parameters<
  typeof import('./domain-manifest/catalog-builder.ts').buildDomainManifestCatalog
>[1];
export type CordisAtlasCatalogService = ((
  ...args: Parameters<typeof import('./domain-manifest/catalog-builder.ts').buildDomainManifestCatalog>
) => ReturnType<typeof import('./domain-manifest/catalog-builder.ts').buildDomainManifestCatalog>['domain_manifests']) & {
  buildStandardAgent(
    contracts: Parameters<typeof import('./domain-manifest/standard-agent-catalog.ts').buildStandardAgentDomainManifestCatalog>[0],
    options: Parameters<typeof import('./domain-manifest/standard-agent-catalog.ts').buildStandardAgentDomainManifestCatalog>[1],
  ): ReturnType<typeof import('./domain-manifest/standard-agent-catalog.ts').buildStandardAgentDomainManifestCatalog>['domain_manifests'];
};
