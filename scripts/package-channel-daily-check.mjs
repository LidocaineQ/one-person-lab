...
function fallbackSummary(options, current, input) {
  ...
  return {
    ...
    candidate_ecosystem_fingerprint: input.candidateEcosystemFingerprint ?? {},
    current_ecosystem_fingerprint: input.currentEcosystemFingerprint ?? {},
...
function buildSummary(options) {
  ...
  if (blockingComponents.length > 0) {
    return fallbackSummary(options, current, {
      ...
      currentFingerprint,
      candidateEcosystemFingerprint,
      currentEcosystemFingerprint,
      blockingComponents,
