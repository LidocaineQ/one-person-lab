...
import pluginDescriptorSchema from '../contracts/cordis-plugin-descriptor.schema.json' with { type: 'json' };
import compositionSnapshotSchema from '../contracts/cordis-composition-snapshot.schema.json' with { type: 'json' };
import {
...
export const CORDIS_PLUGIN_DESCRIPTOR_SCHEMA_REF =
  'packages/cordis-abi/contracts/cordis-plugin-descriptor.schema.json' as const;
export const CORDIS_COMPOSITION_SNAPSHOT_SCHEMA_REF =
  'packages/cordis-abi/contracts/cordis-composition-snapshot.schema.json' as const;
